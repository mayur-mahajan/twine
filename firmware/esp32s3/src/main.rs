//! Example firmware: Twine on an ESP32-S3 with an SPI display (ILI9341, ST7789) or a quad-SPI
//! AMOLED (CO5300, SH8601, RM67162) and a touch controller. A template to copy, not board
...
//! (`demo-counter`, `demo-controls`, `demo-calibrate`). `firmware/README.md` lists the pins of
//! known boards.
//!
...
#[cfg(any(feature = "panel-ili9341", feature = "panel-st7789", feature = "touch-xpt2046"))]
...
const _: () = assert!(
    cfg!(feature = "panel-ili9341") as u8
        ...
        + cfg!(feature = "panel-co5300") as u8
        + cfg!(feature = "panel-sh8601") as u8
        + cfg!(feature = "panel-rm67162") as u8
        == 1,
...
async fn main(_spawner: embassy_executor::Spawner) -> ! {
    ...
    // SPI panel on SPI2 with DMA (ESP32-S3-DevKitC-1 + 2.8" ILI9341 module).
    #[cfg(any(feature = "panel-ili9341", feature = "panel-st7789"))]
    ...
    #[cfg(any(feature = "panel-co5300", feature = "panel-sh8601", feature = "panel-rm67162"))]
    ...
    #[cfg(any(feature = "panel-co5300", feature = "panel-sh8601"))]
    const ROTATION: Rotation = Rotation::Deg0;
    #[cfg(feature = "panel-rm67162")]
    const ROTATION: Rotation = Rotation::Deg270; // landscape 536 × 240, the vendor's default
    ...
    // Capacitive touch on I2C0 (features `touch-ft6x36`, `touch-cst816s`).
    #[cfg(any(feature = "touch-ft6x36", feature = "touch-cst816s"))]
    ...
    let touch = {
        ...
        #[cfg(all(feature = "touch-cst816s", not(feature = "touch-ft6x36")))]
    ...
    // wider panels; each chunk is a single DMA transfer).
